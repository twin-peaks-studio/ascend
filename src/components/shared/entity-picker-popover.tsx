...
interface EntityPickerContentProps {
  workspaceId: string;
...
/**
 * Standalone entity picker list (search + grouped checkboxes).
 * Can be rendered inside any container (popover, drawer, inline).
 */
export function EntityPickerContent({
  workspaceId,
  linkedEntityIds,
  onToggle,
